...
Възможни екшъни:
    ...
    Отговор: {isHighScore: true|false, position: <Number>}
    ...
    Логика - изчиства хайскора за съответната игра
    Отговор: true|false


Възможна употреба - AJAX на същия сървър на който се пуска играта
JSONP -  от bashibozuk.eu